/*
    ...
    by Professor. Mohan using the Dropbox Developer API Library.
...
public class DropboxDriver {
    ...
    public void uploadFile(String filePath, String dropboxPath, DbxClientV2 client){
        ...
        try (InputStream in = new FileInputStream(filePath)) {
            Metadata metadata1 = client.files().delete(dropboxPath);
    ...
    public static void main(String args[]) throws DbxException, IOException {
        ...
        String filePath = "/home/c/castellanosr/cs441s2018/cmpsc441-toccin-castellanosr-mahoneyr";
        String dropboxDownloadPath = "/home/c/castellanosr/cs441s2018/cmpsc441-toccin-castellanosr-mahoneyr";
        String downloadFileName = "Dummy.txt";
        String dropboxUploadPath = "/home/c/castellanosr/cs441s2018/cmpsc441-toccin-castellanosr-mahoneyr";
